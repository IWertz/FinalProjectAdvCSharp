    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 3, "Iw062401!", "IWertz" });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "ReviewId", "Rating", "ReviewContent", "UserId" },
                values: new object[] { 1, 4, "It's pretty good", 1 });

            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "GameId", "Rating", "ReviewId", "Title" },
                values: new object[] { 1, 4.0, 1, "Portal 2" });
